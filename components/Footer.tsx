        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="tel:0585065359" className="flex items-center gap-3 text-white/70 hover:text-white transition-colors">
                  <Phone className="w-5 h-5 shrink-0" />
                  <span dir="ltr">058-506-5359</span>
                </a>
              </li>
              <li>
                <a href="https://wa.me/972585065359" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-white/70 hover:text-white transition-colors">
