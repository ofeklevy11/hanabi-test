...
export default function AppointmentForm() {
  ...
  return (
    <section id="appointment" className="py-8 md:py-10 bg-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-charcoal mb-4 leading-tight">
            קביעת פגישת <span className="text-deep-red">ייעוץ</span>
          </h2>
          <p className="text-xl md:text-2xl text-charcoal-light max-w-3xl mx-auto leading-relaxed font-normal">
            מלא את הפרטים ונחזור אליך בהקדם לתיאום אבחון טכנולוגי
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            <div className="space-y-6">
              ...
              <div>
                <label htmlFor="email" className="block text-charcoal font-semibold mb-3 text-right text-lg">
                  אימייל
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="treatment" className="block text-charcoal font-semibold mb-3 text-right text-lg">
                  תחום עניין
                </label>
                <select
                  id="treatment"
                ...
                >
                  ...
                  <option value="hair-transplant">השתלת שיער</option>
                  <option value="eyebrows">השתלת גבות</option>
                  <option value="eyelashes">השתלת ריסים</option>
                  <option value="iprf">טיפול iPRF</option>
                  <option value="consultation">ייעוץ כללי</option>
                </select>
              </div>

              <div>
                <label htmlFor="message" className="block text-charcoal font-semibold mb-3 text-right text-lg">
                  הודעה (אופציונלי)
                </label>
                <textarea
                  id="message"
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full px-5 py-4 border-2 border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-deep-red/20 focus:border-deep-red transition-all text-right text-lg bg-gray-50/50 hover:bg-white resize-none"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-deep-red text-white px-8 py-5 rounded-full text-lg font-semibold hover:opacity-90 transition-all flex items-center justify-center gap-3 shadow-modern-lg shadow-red-glow mt-4"
              >
                שלח בקשה
