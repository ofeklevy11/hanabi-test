...
export default function EyebrowsLP() {
  ...
  useEffect(() => {
    ...
    if ((window as any).YT?.Player) {
      // Small delay to let iframe mount in DOM
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = { ...formData, source: 'דף נחיתה השתלת גבות', submittedAt: new Date().toLocaleString('he-IL', { timeZone: 'Asia/Jerusalem' }) }
      await Promise.all([
